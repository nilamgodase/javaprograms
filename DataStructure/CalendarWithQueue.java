/******************************************************************************
 *  Compilation:  javac -d bin CalendarWithQueue.java
 *  Execution:    java -cp bin com.Bridgelabz.util
 *  
 *  Purpose:Calendar with Queue
 *  @author  Nilam Godase
 *  @version 1.0
 *  @since   25-02-2019
 *
...
public class CalendarWithQueue 
	...
	{   //take the week of the day using queue 
				Queue queue = new Queue();   //created object of queue
				for(int i=0; i<7; i++) 
				{    //check the week of day using for loop
					for(int j=0; j<7; j++) 
					{
			...
			public static void main(String args[]) {
				...
				String arr[][] = cal.calendar(2019,03);  //passed the value of year and month
//				cal.display(arr);
