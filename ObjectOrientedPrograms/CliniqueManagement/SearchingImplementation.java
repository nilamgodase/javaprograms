		...
		List<Appointment> appointmentlist = new ArrayList<>();
		{
			try {
				...
				personlist = mapper.readValue(
						new File("/home/admin1/eclipse-workspace/bridgelabz/src/CliniqueManagement/Patients.json"),
						new TypeReference<List<Patients>>() {
						});
				doctorlist = mapper.readValue(
						new File("/home/admin1/eclipse-workspace/bridgelabz/src/CliniqueManagement/Doctor.json"),
