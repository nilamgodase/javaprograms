...
import java.util.stream.Collectors;import org.codehaus.jackson.map.ObjectMapper;
...
public class DoctorPatientImplementation implements DoctorAndPatientData {
	...
	List<Appointment> appointmentlist = new ArrayList<>(); // create arraylist to store appointment details
	{
		try {
			...
			personlist = mapper.readValue(new File(
					"/home/admin1/eclipse-workspace/bridgelabz/src/CliniqueManagement/Patients.json"),
					new TypeReference<List<Patients>>() {
					});
			doctorlist = mapper.readValue(new File(
					"/home/admin1/eclipse-workspace/bridgelabz/src/CliniqueManagement/Doctor.json"),
					new TypeReference<List<Doctor>>() {
					});
			appointmentlist = mapper.readValue(new File(
					"/home/admin1/eclipse-workspace/bridgelabz/src/CliniqueManagement/Appointment.json"),
	...
	public void addDoctor() {
		...
		name = Utility.getStrings();
		System.out.println("Enter Specalization");
		specialization = Utility.getStrings();
		System.out.println("Enter Availability(AM/PM/BOTH)");
		availability = Utility.getStrings();
		id = 0;
...
//fix appointment
	...
	public void fixAppointment() {
		...
		String avail = Utility.getStrings();
		System.out.println("Enter Patient Phone Number");
		String patientphone = Utility.getStrings();
